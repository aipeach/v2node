...
import (
	...
	xrayss "github.com/xtls/xray-core/proxy/shadowsocks"
...
func reload(config string, nodes **node.Node, v2core **core.V2Core) error {
	...
	applyIPUserCacheConfig(newConf)
